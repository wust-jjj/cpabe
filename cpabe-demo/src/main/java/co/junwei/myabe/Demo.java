...
public class Demo {
    ...
    static String dir = "demo/Myabe";

    static String pubfile = dir + "/pub_key";//公共文件的路径
    static String mskfile = dir + "/master_key";//主秘钥文件的路径
    static String prvfile = dir + "/prv_key";//私钥文件的路径

    static String inputfile = dir + "/input.pdf";// 要加密的文件路径
    static String encfile = dir + "/input.pdf.cpabe";//加密后的文件路径
    static String decfile = dir + "/input.pdf.new";//解密后的文件路径

    static String[] attr = { "baf1", "fim1", "foo" };//私有属性
    static String policy = "foo bar fim 2of3 baf 1of2";//访问结构树
    ...
    static String attrs_all = "objectClass:inetOrgPerson objectClass:organizationalPerson "
            + "sn:student2 cn:student2 uid:student2 userPassword:student2 "
            + "ou:idp o:computer mail:student2@sdu.edu.cn title:student "
            + "position:student age:18";

    static String student_policy = "sn:student2 cn:student2 uid:student2 3of3";

    public static void main(String[] args) throws Exception {
        String my_attr,attr_all;
        // attr = attr_kevin;
        // attr = attr_sara;
        ...
        attr_all = attrs_all;
        my_attr = student_attr;
        policy = student_policy;

        MyabeTools test = new MyabeTools();
        MyabePub pub = new MyabePub();
        MyabeMsk msk = new MyabeMsk();
        MyabePrv prv = new MyabePrv();

        println("//start to setup");
        test.setup(pub, msk,attr_all);
        println("//end to setup");

        println("//start to keygen");
        prv = test.keygen(pub, msk, my_attr);
